...
type BenchmarkSchema struct {
  ...
  Name       string           `gorm:"type:varchar(255);not null;uniqueIndex:idx_bench_name_version" json:"name"`
  Version    string           `gorm:"type:varchar(50);not null;uniqueIndex:idx_bench_name_version" json:"version"`
